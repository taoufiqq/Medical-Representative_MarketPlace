        ...
        { products && products.map(item =>(
           <div className="sm:w-1/4 mb-10 px-4">
               <div className="rounded-lg  overflow-hidden ">
                  <img alt="content" className="object-cover object-center " src={item.productImg} style={{width:300,height:300}} />
               </div>
                  <h2 className="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">{item.titel}</h2>
