          ...
          <aside className="flex-shrink-0 p-4 w-72 h-full">
            <div className="flex flex-col h-full pt-12 pb-4 rounded-lg neumorphism-shadow">
              ...
              <div className="flex flex-col items-center justify-center flex-shrink-0 px-4 py-2 mx-4 rounded-lg neumorphism-shadow bg-blue-300">
                ...
                <span href="" target="_blank" className="mt-3 px-4 py-1 rounded-md text-xl font-semibold tracking-wider text-gray-600  focus:outline-none">Welcom {item.firstName +" "+ item.lastName}</span>
...
<div className="overflow-x-auto" style={{width:1200}}>
  ...
  <div className=" flex items-center justify-center font-sans " style={{marginTop:150,marginLeft:250}}>
    ...
    <Link to='/addAdmin' class="bg-blue-300 hover:bg-green-100 text-black font-bold py-2 px-4 rounded-md">Add Admin</Link>
            ...
            <tr className="border-b border-gray-200 hover:bg-gray-100">
              ...
              <td className="py-3 px-6 text-center">
                ...
                <div className="flex item-center justify-center">               
                  <Link onClick={()=>getIdAdmin(item._id)} className="w-4 mr-2 transform hover:text-yellow-500 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                  </Link>
                  <Link onClick={()=>deleteAdmin(item._id)} className="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
